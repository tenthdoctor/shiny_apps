...
shinyUI(navbarPage("Image Processing",
                   tabPanel("Basic Operations",
                            fluidPage(
                              sidebarLayout(
                                sidebarPanel(
                                  textInput("url", label = h6("Enter Image URL"), value = "https://hgtvhome.sndimg.com/content/dam/images/hgtv/stock/2018/4/3/0/shutterstock_Chutharat-Kamkhuntee_683363251_corn-growing.jpg.rend.hgtvcom.616.347.suffix/1522768591804.jpeg"),
